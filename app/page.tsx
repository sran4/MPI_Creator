  ...
  const features = [
    {
      ...
      description:
        'Create both MPI and Traveler documents in one streamlined process with drag & drop sections',
      color: 'text-blue-400',
    },
    {
      icon: Users,
      ...
      description:
        'Admin controls with engineer assignments and role-based access',
    ...
    },
    {
      ...
      description:
        'IPC-A-610, J-STD-001, ISO 9001, AS9100, ISO 13485, IATF 16949',
      color: 'text-red-400',
    },
    {
      icon: Zap,
          ...
          <div className='flex items-center justify-between'>
            <div>
              ...
              <p className='text-white opacity-80'>
                Create both MPI and Traveler documents in one process for PCBA
              </p>
            </div>
      ...
      <main className='max-w-7xl mx-auto px-6 pb-8'>
        ...
        >
          ...
          <p className='text-xl text-white opacity-80 mb-8 max-w-3xl mx-auto'>
            Professional web-based application for creating both Manufacturing
            Process Instructions (MPI) and Traveler documents specifically
            designed for Printed Circuit Board Assembly (PCBA) companies.
          </p>
          ...
          <Card className='glassmorphism-card glassmorphism-card-hover max-w-4xl mx-auto'>
            <CardContent className='p-12'>
              ...
              <p className='text-white opacity-80 mb-8 text-lg'>
                Join hundreds of PCBA companies already using MPI Traveler Combo
                Creator to streamline their processes.
              </p>
              <div className='flex justify-center space-x-4'>
                <Button
                  size='lg'
      ...
      <footer className='glassmorphism-card glassmorphism-card-hover mt-16 p-6'>
        <div className='max-w-7xl mx-auto text-center'>
          <p className='text-white opacity-60'>
            © 2024 MPI Traveler Combo Creator. All rights reserved. Built for
            PCBA manufacturing excellence.
          </p>
        </div>
      </footer>
    </div>
