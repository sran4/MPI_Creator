...
export default function AdminMPIPrintPreviewPage() {
  ...
  return (
    <>
      ...
      <style jsx global>{`
        @media print {
          @page {
            ...
            /* Remove any default page borders */
          ...
          /* Remove all possible borders and backgrounds */
          *, *::before, *::after {
            border: none !important;
          ...
          * {
          ...
          /* Optimize section spacing for print - reduce empty space */
          .print-section {
            break-inside: avoid;
          ...
          /* Reduce spacing in section content */
          .print-section h3 {
            margin-bottom: 0.5rem !important;
          ...
          /* Remove any print preview specific styling */
          .print-preview-header {
            display: none !important;
          }
          /* Force content to start at top of page */
          .print-content {
            margin-top: 0 !important;
          ...
          /* Ensure content containers have no borders and optimize spacing */
      ...
      <div className="min-h-screen print-content" data-form-id={mpi.formId?.formId || mpi._id || 'N/A'} data-print-date={new Date().toLocaleDateString() + ', ' + new Date().toLocaleTimeString()}>
