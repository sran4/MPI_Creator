...
export default function NewTaskPage() {
  ...
  const wordCount = formData.step.trim().split(' ').filter(word => word.length > 0).length
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-white opacity-80">Create a new task for your MPI processes</p>
            </div>
          </div>
        </div>
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex justify-end space-x-3 pt-4">
                  ...
                  <Button
                    type="submit"
                    disabled={isCreating || wordCount > 150 || !formData.step.trim() || !formData.processItemId}
