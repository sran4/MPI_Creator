...
export default function CustomersPage() {
  ...
  const [deleteModal, setDeleteModal] = useState<{ isOpen: boolean; company: CustomerCompany | null }>({
    isOpen: false,
    company: null
  })
  const [viewModal, setViewModal] = useState<{ isOpen: boolean; company: CustomerCompany | null }>({
    isOpen: false,
    company: null
  })
    ...
    return (
      <div className="min-h-screen gradient-bg dark:gradient-bg flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-white opacity-80">Loading customer companies...</p>
        </div>
      </div>
    )
  }
    ...
    <div className="min-h-screen gradient-bg dark:gradient-bg">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="space-y-8">
          {/* Active Companies */}
          {paginatedCompanies.filter(company => company.isActive).length > 0 && (
            <div>
              <h3 className="text-lg font-semibold text-white mb-4 flex items-center">
                <span className="w-3 h-3 bg-green-500 rounded-full mr-3"></span>
                Active Companies ({filteredCompanies.filter(company => company.isActive).length})
              </h3>
              <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5">
                {paginatedCompanies.filter(company => company.isActive).map((company) => (
            <motion.div
              key={company._id}
              ...
              <Card className="glassmorphism-card glassmorphism-card-hover h-full">
                <CardHeader>
                  <div className="flex items-center justify-between">
                    ...
                    <Badge variant={company.isActive ? "default" : "secondary"} className="bg-green-600 text-white">
          ...
          {paginatedCompanies.filter(company => !company.isActive).length > 0 && (
            <div>
              <h3 className="text-lg font-semibold text-white mb-4 flex items-center">
                ...
                Inactive Companies ({filteredCompanies.filter(company => !company.isActive).length})
              </h3>
              <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5">
                {paginatedCompanies.filter(company => !company.isActive).map((company) => (
                  <motion.div
                    ...
                    <Card className="glassmorphism-card glassmorphism-card-hover h-full opacity-75">
                      <CardHeader>
                        <div className="flex items-center justify-between">
                          ...
                          <Badge variant={company.isActive ? "default" : "secondary"} className="bg-gray-600 text-white">
                            {company.isActive ? 'Active' : 'Inactive'}
                          </Badge>
                        </div>
                      </CardHeader>
            ...
            >
              <div className="text-center">
                ...
                <p className="text-white/80 mb-6">
                  Are you sure you want to delete <strong>{deleteModal.company.companyName}</strong>? 
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <p className="text-white font-medium">{viewModal.company.companyName}</p>
                        </div>
                      </div>
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <p className="text-white font-medium">{viewModal.company.city}, {viewModal.company.state}</p>
                        </div>
                      </div>
                      {viewModal.company.address && (
                        <div className="flex items-start">
                          ...
                          <div>
                            ...
                            <p className="text-white font-medium">{viewModal.company.address}</p>
                          </div>
                        </div>
                      )}
                    </div>
                      ...
                      {viewModal.company.contactPerson ? (
                        <div className="flex items-center">
                          ...
                          <div>
                            ...
                            <p className="text-white font-medium">{viewModal.company.contactPerson}</p>
                          </div>
                        </div>
                      ) : (
                        <div className="flex items-center">
                          ...
                          <div>
                            <p className="text-sm text-white/60">Contact Person</p>
                            <p className="text-white/40 font-medium">Not provided</p>
                          </div>
                        </div>
                      )}
                      {viewModal.company.email ? (
                        <div className="flex items-center">
                          ...
                          <div>
                            ...
                            <p className="text-white font-medium">{viewModal.company.email}</p>
                          </div>
                        </div>
                      ) : (
                        <div className="flex items-center">
                      ...
                      {viewModal.company.phone ? (
                        <div className="flex items-center">
                          ...
                          <div>
                            ...
                            <p className="text-white font-medium">{viewModal.company.phone}</p>
                          </div>
                        </div>
                      ) : (
                        <div className="flex items-center">
              ...
              <div className="mt-6 pt-6 border-t border-white/20">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="text-center">
                    ...
                    <Badge variant={viewModal.company.isActive ? "default" : "secondary"} className="bg-green-600 text-white mt-1">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-white font-medium mt-1">
                      {viewModal.company.createdAt ? new Date(viewModal.company.createdAt).toLocaleDateString() : 'N/A'}
                    </p>
                  </div>
                  <div className="text-center">
                    <p className="text-sm text-white/60">Last Updated</p>
                    <p className="text-white font-medium mt-1">
                      {viewModal.company.updatedAt ? new Date(viewModal.company.updatedAt).toLocaleDateString() : 'N/A'}
                    </p>
                  </div>
                </div>
              </div>
