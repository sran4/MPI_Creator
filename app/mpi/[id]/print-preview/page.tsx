      ...
      <style jsx global>{`
        @media print {
          ...
          @page {
            ...
            @bottom-left {
              content: 'Engineer: ${mpi.engineerId?.fullName || 'N/A'}';
              font-size: 12pt;
      ...
      <div className='flex h-screen'>
                      ...
                      <div className='flex space-x-1'>
                        {[25, 50, 75, 100].map(size => (
                          <Button
                            ...
                            size='sm'
                            onClick={() =>
                              setImageSize(section.id, imageIndex, size)
                            }
                            className={`${
            ...
            <div className='max-w-4xl mx-auto p-6'>
              ...
              <div className='mb-8 border-2 border-gray-300 rounded-lg p-6 live-preview-section'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4 text-gray-900'>
                  ...
                  <div>
                    <span className='font-semibold'>Assembly Quantity:</span>{' '}
                  ...
                  <div>
                    <span className='font-semibold'>Kit Received Date:</span>{' '}
                    {mpi.kitReceivedDate
                      ? new Date(mpi.kitReceivedDate).toLocaleDateString()
                      : 'N/A'}
                  </div>
                  <div>
                    <span className='font-semibold'>Kit Release Date:</span>{' '}
                    {mpi.dateReleased
              ...
              <div className='space-y-6'>
                {mpi.sections.map((section, sectionIndex) => (
                  ...
                  >
                    ...
                    <div
                      className={`prose max-w-none interactive-text-spacing`}
                    >
                      <div
                            ...
                            >
                              <img
                                ...
                                className={`max-w-full h-auto rounded border ${
                                  imageSizes[`${section.id}-${imageIndex}`] ===
                                  25
                                    ? 'image-size-25'
                                    : imageSizes[
        ...
        <div className='w-64 bg-white border-l border-gray-200 flex flex-col quick-actions-panel'>
          ...
          <div className='flex-1 p-4 space-y-4'>
            ...
            <Link href={`/mpi/${params.id}/edit`} className='block'>
              <Button
                variant='outline'
                className='w-full bg-white text-gray-700 border-gray-300 hover:bg-gray-50'
              >
      ...
      <div className='hidden print:block fixed bottom-0 left-0 right-0 bg-white border-t-2 border-black p-3 text-sm font-bold text-black'>
        <div className='flex justify-between items-center max-w-4xl mx-auto'>
          <div className='font-bold'>
            Engineer: {mpi.engineerId?.fullName || 'N/A'}
          </div>
