...
export default function AllMPIsPage() {
  ...
  const filteredMPIs = mpis.filter(mpi => {
    const matchesSearch =
      mpi.mpiNumber.toLowerCase().includes(searchTerm.toLowerCase()) ||
      mpi.jobNumber.toLowerCase().includes(searchTerm.toLowerCase()) ||
      mpi.customerAssemblyName
        .toLowerCase()
      ...
      <div className='max-w-7xl mx-auto px-6 py-8 relative z-10'>
          ...
          <div className='flex items-center space-x-4'>
            ...
            <div>
              ...
              <p className='text-white opacity-80'>
                View and manage all your MPI/Traveler Combo documents
              </p>
            </div>
          </div>
        ...
        <div className='flex flex-col sm:flex-row gap-4 mb-6'>
          ...
          <div className='flex items-center space-x-2'>
            ...
            >
              <option value='all' className='bg-red-500/20 text-white'>
                All Status
              </option>
              <option value='draft' className='bg-red-500/20 text-white'>
                Draft
              </option>
              <option value='in-review' className='bg-red-500/20 text-white'>
                In Review
              </option>
              <option value='approved' className='bg-red-500/20 text-white'>
                Approved
              </option>
              <option value='rejected' className='bg-red-500/20 text-white'>
                Rejected
              </option>
            </select>
          </div>
                  ...
                  <div className='flex items-center justify-between'>
                    <div className='flex items-center space-x-6'>
                      <div>
                        <h3 className='text-white font-semibold text-lg'>
                          {mpi.mpiNumber}{' '}
                          {mpi.mpiVersion ? `Rev ${mpi.mpiVersion}` : ''}
                        </h3>
                    ...
                    <div className='flex items-center space-x-3'>
                      ...
                      <div className='flex items-center space-x-2'>
                        ...
                        <button
                          onClick={() =>
                            openDeleteModal(mpi._id, mpi.mpiNumber)
                          }
          ...
          <div className='flex items-center justify-between mt-8'>
            ...
            <div className='flex items-center space-x-4'>
              <span className='text-white/70 text-sm'>
                ...
                {Math.min(endIndex, filteredMPIs.length)} of{' '}
                {filteredMPIs.length} MPIs
              </span>
            </div>
          </div>
        )}
          ...
          <div className='glassmorphism-card p-6 max-w-md w-full mx-4'>
            ...
            <p className='text-white/80 mb-6'>
              ...
              <span className='font-semibold text-white'>
                {deleteModal.mpiNumber}
              </span>
              ? This action cannot be undone and will permanently remove the MPI
            ...
            <div className='flex space-x-3'>
              ...
              <Button
                onClick={() =>
                  deleteModal.mpiId && handleDeleteMPI(deleteModal.mpiId)
                }
