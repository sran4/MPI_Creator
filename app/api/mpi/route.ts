...
export async function POST(request: NextRequest) {
  try {
    ...
    const defaultSections = [
      ...
      {
        id: 'smt-prep',
        title: 'SMT Preparation/Planning',
        content: '',
        order: 4,
        isCollapsed: false,
        images: [],
      ...
      {
        id: 'smt-additional',
        title: 'SMT Additional Instructions',
        content: '',
        order: 8,
        isCollapsed: false,
        images: [],
      ...
      {
        id: 'second-operations',
        title: '2nd Operations',
        content: '',
        order: 11,
        isCollapsed: false,
        images: [],
